...
-- PHẦN A. PHÂN TÍCH VÀ TÁI HIỆN LỖI


-- 1. Truy vấn View hiện tại
SELECT * 
FROM reception_patient_view;

-- Các cột vi phạm quy tắc bảo mật:
-- - hiv_status
-- - mental_health_history

-- 2. Cập nhật tuổi sai quy tắc để chứng minh View chưa kiểm soát dữ liệu
...
-- 4. Thử cập nhật sai (sẽ bị từ chối)
UPDATE reception_patient_view
SET age = -5
WHERE patient_id = 1;