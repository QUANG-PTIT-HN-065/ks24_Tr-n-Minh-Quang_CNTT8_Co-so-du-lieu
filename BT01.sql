...
Stored Procedure hiện tại cập nhật trạng thái lịch khám mà không kiểm tra trạng thái hiện tại của lịch hẹn.

Vì vậy, các lịch đã Completed vẫn có thể bị đổi sang Cancelled, gây sai lệch dữ liệu. */
